...
class StoreModel extends CI_Model
{
	...
	public function getBags(){
		$this->db->select('
		tbl_product.product_id_pk,tbl_product.brand_name,tbl_product.product_type,tbl_product_price.product_id_fk,tbl_product_price.discount_price,tbl_product_img.product_id_fk,tbl_product_img.pro_image
		')

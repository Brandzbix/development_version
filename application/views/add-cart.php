	...
	<div class="container-fluid">
		<div class="row border-space">
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				...
				<h2>Shopping Cart</h2>
					<img src="<?php echo base_url(); ?>assets/img/shop-add.png">
					<div class="shoping-dtl">						
						<h3>Samsung Galaxy M30 (Gradation Black, 4+64 GB) </h3>
			...
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
				<div class="price-detail">
					<h3>Price</h3>
					<span><i class="fa fa-inr" aria-hidden="true"></i> 13,990.00</span>
				</div>
			</div>
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
				<div class="quantity-block">
					<h3>Quantity</h3>
					<select class="form-control drop-menu">
		...
		<div class="row">
			<div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12">
				<div class="grnd-btn-kart">
					<h3>Subtotal(1 item)<span><i class="fa fa-inr" aria-hidden="true"></i> 13,990.00</span></h3>

...
<head>
    ...
    <title>Apple Therapeutics | Admin Dashboard</title>
...
<body>
    <div class="text-center animated fadeInDown">
        <div class="">
            <div class="logo-name">
                <image src="<?php echo base_url();?>/assets/admin_assets/img/logo.png" style="width: 500;">
            </div>
            <!-- <h1 class="logo-name">N+</h1> -->
        </div>
       <h3 class="logo-heading">ADMIN</h3>
    <h3 class="logo-heading">welcome to apple therapeutics</h3>
...
<div class="container middle-box animated fadeInUp">
   <div class="row justify-content-center">
      <div class="col-md-12 mb-5 element-animate fadeInUp element-animated">
         <form action="<?php echo base_url();?>admin/LoginController/forgotAuthontication" method="post" name="adminLogin" id="feedbackForm" novalidate="">
            <div class="row">
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/website_assets/parsley/parsley.extend.js');?>"></script>

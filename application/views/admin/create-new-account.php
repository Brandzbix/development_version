...
<body>
 <div class="text-center animated fadeInDown">
    ...
    <h3 class="logo-heading">Register</h3>
 </div>
<div class="container middle-box animated fadeInUp">
   <div class="row justify-content-center">
      <div class="col-md-12 mb-5 element-animate fadeInUp element-animated">
         <form action="<?php echo base_url();?>admin/LoginController/doRegister" method="post" name="adminLogin" id="feedbackForm" novalidate="">
            <div class="row">
               ...
               <div class="col-md-12 form-group">
                  <label for="password" class="newsbox-head">Confirm Password *</label>
                  <input type="password" class="form-control form-control-lg" id="password" placeholder="Enter password here." name="cpassword" data-parsley-required="" data-parsley-error-message="Password id is required">
               </div>
            </div>
            <div class="row">
               <div class="col-md-12 form-group">
